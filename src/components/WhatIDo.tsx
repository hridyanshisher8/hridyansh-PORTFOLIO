        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              <h3>DATA ANALYSIS</h3>
              <h4>Extracting Insights</h4>
              <p>
                Transforming raw data into actionable insights using advanced analytics.
                From data cleaning to interactive dashboards, I uncover hidden patterns.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Designing robust machine learning models to solve complex real-world problems.
                From feature engineering to deployment, I build models that scale.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                <div className="what-tags">Python</div>
