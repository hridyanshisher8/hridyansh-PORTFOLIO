          ...
          <div className="career-info-box">
            <div className="career-info-in">
              <div className="career-role">
                ...
                <h5>
                  <a href="https://www.coursera.org/account/accomplishments/verify/8EZF9AM8AX48" target="_blank" rel="noopener noreferrer" style={{ color: "inherit", textDecoration: "none" }}>
                    Google 🔗
                  </a>
                </h5>
              </div>
